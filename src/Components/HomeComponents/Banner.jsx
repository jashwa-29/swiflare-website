...
Experience
        ...
        <div className="mt-10">
         <button className="bg-[#3FA2F6] rounded-full w-auto px-6 py-3 text-white mx-auto flex items-center gap-3 text-base sub-font hover:bg-[#AD49E1] hover:scale-90 transition-all duration-500 group ease-in-out">
